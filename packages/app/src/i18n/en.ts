export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Paddie Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Paddie Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Paddie Studio.",
  ...
  "dialog.server.description": "Switch which Paddie Studio server this app connects to.",
  ...
  "error.page.report.prefix": "Please report this error to the Paddie Studio team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Paddie Studio does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Paddie Studio includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Paddie Studio",
  ...
  "settings.desktop.wsl.description": "Run the Paddie Studio server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Paddie Studio",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Paddie Studio looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Paddie Studio follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Paddie Studio is themed.",
