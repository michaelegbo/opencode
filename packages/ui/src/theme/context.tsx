...
const STORAGE_KEYS = {
  THEME_ID: "paddie-studio-theme-id",
  COLOR_SCHEME: "paddie-studio-color-scheme",
  THEME_CSS_LIGHT: "paddie-studio-theme-css-light",
  THEME_CSS_DARK: "paddie-studio-theme-css-dark",
} as const
